...
import { MessageCircle, Send, FolderKanban } from "lucide-react";
      ...
      <div className="animate-fade-in space-y-6">
        ...
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Manage your team and communicate
          </p>
        </div>

        {/* Communication Hub */}
        <div className="glass-card flex h-[calc(100vh-14rem)] overflow-hidden">
          {/* Team List */}
